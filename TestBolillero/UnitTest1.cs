...
namespace TestBolillero
{
    public class UnitTest1
    {
        ...
        public UnitTest1()
        {
            ...
            List<int> numerosWin = new List<int> { 0, 1, 2, 3 }; 
        ...
        public void GanarNVeces()
        {
            ...
            int vecesGanadas = bolilleroGana.JugarNVeces();
        ...
        public void JugarRandomOK()
        {
            ...
            Assert.Equal(6, bolillero.Bolitas.Count);
            Assert.Equal(4, bolillero.BolillasFuera.Count);
